...
const Tech = () => {
  ...
  <div className=''>
    ...
    <div className='bg-slate-50 flex flex-col w-screen lg:flex-row-reverse items-center md:justify-evenly text-center md:text-left'>
      ...
      <div className='px-10 pb-4  mx-auto md:p-8 xl:px-16  w-screen font-TTNormsLight text-sm lg:text-base text-justify md:max-w-1/2'>
        <Fade triggerOnce>{t("tech.tecno1")}</Fade>
      </div>
      
  <Fade/>
  
      <div className='p-5 md:pl-36 md:p-2 hidden lg:inline xl:pl-40 w-1/2'>
       <Fade triggerOnce> <img className='w-52 md:w-96 xl:scale-75  '
