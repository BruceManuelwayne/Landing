...
const Valores = () => {
  ...
  return (
    <>
    <Fade triggerOnce>
        <div className="bg-[url('/src/assets/backgroundModulos.webp')] bg-cover w-screen h-auto lg:h-screen xl:h-auto p-2 lg:p-8 text-white grid content-start " id='valores' >
